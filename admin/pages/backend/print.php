...
<html>
	...
	<body>
		<center>
			...
			<center><h1>Bibliographic Entry Template (Graduate School)</h1></center>
			<div>
				<table border="0">
					<tbody>	
						...
						<tr><td style="border:1px solid black;" height="50" width="225">Thesis/Adjectivial Rating</td><td style="border:1px solid black;"><?php echo $fetch['thesis'];?></td></tr>
