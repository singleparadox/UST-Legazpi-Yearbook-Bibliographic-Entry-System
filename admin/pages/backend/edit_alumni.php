<?php
  ...
  $sql = "SELECT * FROM alumni, alumni_details, course, college, rating WHERE alumni.alum_detail_id=alumni_details.alum_detail_id AND course.course_id=alumni.course_id AND alumni.college_id=college.college_id AND alumni_details.rating_id=rating.rating_id AND alumni.alum_id=".$alumni_id;
