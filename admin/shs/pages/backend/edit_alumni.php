<?php
  ...
  $sql = "SELECT * FROM shs_alumni, shs_details, strand, track WHERE shs_alumni.shs_alum_details_id=shs_details.shs_alum_details_id AND shs_alumni.track_id=track.track_id AND strand.strand_id=shs_alumni.strand_id AND shs_alumni.shs_alum_id=".$alumni_id;
